...
class QuizViewCon: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "img1", questionText: "What is 7 x 6 ?", options: ["27", "41", "42", "36"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "img2", questionText: "What is 17 + 21 ?", options: ["38", "35", "29", "44"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "img1", questionText: "What is 12 / 2 ?", options: ["2", "4", "6", "5"], correctAns: 2, wrongAns: -1, isAnswered: false)
        ...
        let que6 = Question(imgName: "img2", questionText: "What is the color of Kazakhstan flag?", options: ["Red", "Yellow", "Blue", "White"], correctAns: 2, wrongAns: -1, isAnswered: false)
...
extension QuizViewCon: QuizCVCellDelegate {
    func didChooseAnswer(btnIndex: Int) {
        ...
        lblScore.text = "Your Score: \(score) / \(questionsArray.count)"
